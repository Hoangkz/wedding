...
const UserIcon = () => <svg className="w-5 h-5 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
const MessageIcon = () => <svg className="w-5 h-5 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
const SendIcon = () => <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
...
const WeddingWishes = () => {
    const initialWishes: Wish[] = [
        ...
        { id: 1, name: "Gia đình Cô Ba", message: "Chúc hai cháu trăm năm hạnh phúc, sớm có quý tử, công chúa nhé!", timestamp: "01/01 10:30" },
        { id: 2, name: "Bạn thân Tùng", message: "Đã lâu lắm rồi, cuối cùng ngày này cũng đến! Chúc mừng hạnh phúc của hai người, mãi mãi bên nhau nhé!", timestamp: "01/01 10:25" },
        { id: 3, name: "Đồng nghiệp A", message: "Chúc mừng cặp đôi hoàn hảo! Chúc hai bạn luôn ngập tràn tiếng cười và niềm vui.", timestamp: "01/01 10:20" },
        { id: 4, name: "Chị họ Mai", message: "Hạnh phúc viên mãn, mãi mãi bên nhau! Yêu thương hai em!", timestamp: "01/01 10:15" },
        { id: 5, name: "Hàng xóm B", message: "Chúc hai con có một cuộc sống hôn nhân ngọt ngào và bền chặt.", timestamp: "01/01 10:10" },
        // Thêm nữa
        { id: 6, name: "Bác Tư", message: "Vạn sự như ý, tỷ sự như mơ, chúc mừng hai đứa nhé!", timestamp: "01/01 10:05" },
        { id: 7, name: "Bạn cấp 3", message: "Tình yêu tuyệt vời! Chúc hai bạn luôn là chỗ dựa vững chắc cho nhau.", timestamp: "01/01 10:00" },
    ];
        ...
        >
            ...
            <div className="relative z-10 py-30 px-6 md:px-12 text-center">
                ...
                <div className="flex flex-col lg:flex-row gap-8 justify-center items-start">
                    ...
                    <motion.div
                        className="w-full lg:w-7/12 flex flex-col gap-4 text-left"
                    >
