...
const WeddingCard = () => {
    const weddingInfo = {
        ...
        eventDay: "THỨ BẢY",
        eventDate: "11",
        eventMonthYear: "10.2025",
        lunarDate: "(Tức ngày 20 tháng 8 năm Ất Tỵ)",
        venueType: "Tại Tư Gia Nhà Gái",
        venueAddress: "Số 7 Ngõ 37, Thôn Cổ Ngoã Thượng\nXã Liên Minh, Hà Nội",
        welcomeMessage: "Rất hân hạnh được đón tiếp!",
        googleMapsLink: "https://maps.app.goo.gl/your-location-link",
    }
        ...
        >
            ...
            <div className="py-18">
                <div className="relative z-10 py-6 px-6 w-full max-w-sm text-center bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
                    ...
                    >
                        VÀO LÚC <span className="text-lg font-bold text-rose-700">{weddingInfo.eventTimeLarge}</span>
                    </motion.p>
