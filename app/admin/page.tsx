            ...
            <div className="bg-white rounded-xl shadow-xl space-y-6 flex flex-col h-full min-h-0">
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    <div className="p-6 flex-1 space-y-8 overflow-y-auto">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-bold text-blue-600 border-b pb-2 mb-4">
                                <i className="fas fa-users mr-2"></i> Thông tin Gia đình
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                                <Input
                                    type="text"
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-bold text-blue-600 border-b pb-2 mb-4">
                                <i className="fas fa-calendar-alt mr-2"></i> Địa điểm & Thời gian Cưới
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                                <Input
                                    type="date"
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-bold text-blue-600 border-b pb-2 mb-4">
                                <i className="fas fa-qrcode mr-2"></i> Thông tin Ngân hàng & QR Code
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                                <Input
                                    type="text"
                                ...
                                <div className="flex flex-col space-y-2 lg:col-span-3 border p-3 rounded-lg bg-gray-50">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        {(formData.qrCodeFile || formData.qrCodeUrl) && (
                                            <img
                                                src={formData.qrCodeFile ? URL.createObjectURL(formData.qrCodeFile) : formData.qrCodeUrl}
                                                alt="QR Code Preview"
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">Tải lên ảnh QR Code ngân hàng của bạn. Dung lượng tối đa: 1MB.</p>
                                </div>
                            </div>
                        </div>
            ...
            {showPasswordModal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black/60 z-50 transition-opacity duration-300 backdrop-blur-sm p-4">
                    <div className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-sm transform scale-100 transition-transform duration-300">
                        <h2 className="text-2xl font-bold mb-5 text-center text-gray-800 border-b pb-2">Đổi mật khẩu</h2>
...
const Input = ({ label, name, value, onChange, disabled, type = 'text', className = '', placeholder = '', required }: any) => (
